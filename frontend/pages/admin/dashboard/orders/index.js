...
import { manufacturerOrders } from '@/redux/actions/orderAction'
import Link from 'next/link'
import Card from '@/components/Cards/Card'
import {data} from '@/admin/utils/demo/tableData'
import PageTitle from '@/components/Typography/PageTitle'
import { EditIcon, TrashIcon } from '@/admin/icons'
          ...
          <TableBody>
            {dataTable2.map((user, i) => (
              <TableRow key={i}>
                ...
                <TableCell>
                  <Link href={`/admin/dashboard/order/${'orderId'}`}>
