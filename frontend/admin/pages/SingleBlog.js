...
const SingleBlog = ({ match }) => {
  ...
  const singleblog = useSelector((state) => state.post.post);
  ...
  const handleComment = () => {
    ...
    dispatch(addComment(match.params.id, formdata));
    setValues({
      text: "",
    });
  };
              ...
              <div className="w-full">
                ...
                <div>
                  {!singleblog.comments.length
                    ? "No comment yet start a discussion"
                    : singleblog.comments.map((data) => (
                        <Card className="flex-cols">
                          <div className="flex flex-row mt-2 px-2 py-3 mx-3">
                            <div className="w-auto h-auto rounded-full border-2 border-pink-500">
                              <img
                                className="w-12 h-12 object-cover rounded-full shadow cursor-pointer"
