                ...
                <div className="grid grid-cols-1">
                    {
                        blogs && blogs.map( blog => 
                            <div 
                                className="w-2/5 mobile:w-full mx-auto overflow-hidden bg-white relative border px-3 py-2 hover:bg-hover cursor-pointer" 
...
export default memo(AboutManufacturer);
